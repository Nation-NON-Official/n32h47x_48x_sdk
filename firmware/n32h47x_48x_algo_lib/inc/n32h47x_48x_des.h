...
*\*\name    DES_Crypto.
*\*\fun     DES crypto.
*\*\param   parm pointer to DES/TDES context and the detail please refer to struct DES_PARM in DES.h
...
*\*\param   none
*\*\return  none
*\*\note  	if you want to close DES algorithm, this function can be recalled.
**/
void DES_Close(void);

/**
*\*\name    DES_Version.
*\*\fun     Get DES/TDES lib version.
...
*\*\return  none
*\*\note  	1.You can recall this function to get DES/TDES lib information.
**/
