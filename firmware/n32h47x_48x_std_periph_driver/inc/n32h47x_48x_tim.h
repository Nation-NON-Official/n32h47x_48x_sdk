...
/**
*\*\file n32h47x_48x_tim.h
*\*\author Nations
*\*\version v1.0.0
*\*\copyright Copyright (c) 2023, Nations Technologies Inc. All rights reserved.
**/

#ifndef __N32H47X_TIM_H
#define __N32H47X_TIM_H
...
typedef struct
{
    ...
    uint32_t OutputNState; 		  /* Specifies the TIM complementary Output Compare state.
                                                             ...
                                                             This parameter is valid for ATIM and GTIM8-10. */
...
#define IS_ATIM1_3_DEVICE(DEVICE)          (((DEVICE) == ATIM1)  || \
                                            ((DEVICE) == ATIM2)  || \
                                            ((DEVICE) == ATIM3))

/** Whether it is an GTIM1-7 device **/
#define IS_GTIM1_7_DEVICE(DEVICE)          (((DEVICE) == GTIM1)  || \
                                            ((DEVICE) == GTIM2)  || \
                                            ((DEVICE) == GTIM3)  || \
                                            ((DEVICE) == GTIM4)  || \
                                            ((DEVICE) == GTIM5)  || \
...
/** Whether it is an GTIM8-10 device **/
#define IS_GTIM8_10_DEVICE(DEVICE)         (((DEVICE) == GTIM8)  || \
                                            ((DEVICE) == GTIM9)  || \
                                            ((DEVICE) == GTIM10))                                            
...
#define TIM_BREAK_FLECC                     (TIM_CTRL1_FLECCERREN)
...
#define TIM_BREAK_COMP5                     (TIM_AF1_COMP5BRKEN)
#define TIM_BREAK_COMP6                     (TIM_AF1_COMP6BRKEN)
#define TIM_BREAK_COMP7                     (TIM_AF1_COMP7BRKEN)

/** System break input **/
#define IS_SYS_BREAK(SOURCE)                (((SOURCE) == TIM_BREAK_LOCKUP)  || \
                                             ((SOURCE) == TIM_BREAK_PVD)     || \
                                             ((SOURCE) == TIM_BREAK_SMPAR)   || \
                                             ((SOURCE) == TIM_BREAK_FLECC)   || \
...
#define TIM_BREAK2_COMP5                    (TIM_AF2_COMP5BRK2EN)
#define TIM_BREAK2_COMP6                    (TIM_AF2_COMP6BRK2EN)
#define TIM_BREAK2_COMP7                    (TIM_AF2_COMP7BRK2EN)

 /** Polarity of break2 input from IOM **/
#define TIM_BREAK2_SOURCE_POLARITY_INVERT    (TIM_AF2_IOMBRK2P | TIM_AF2_COMP1BRKP | TIM_AF2_COMP2BRKP | TIM_AF2_COMP3BRKP | TIM_AF2_COMP4BRKP)
