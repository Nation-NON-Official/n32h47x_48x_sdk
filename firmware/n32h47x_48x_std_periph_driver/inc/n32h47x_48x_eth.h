...
#ifndef __N32H47X_48X_ETH_H__
#define __N32H47X_48X_ETH_H__
...
typedef enum
{
    ETH_SPEED_10M  = ((uint32_t)0x00000000U),
    ETH_SPEED_100M = ((uint32_t)0x00004000U)
} EthSpeedType;
...
typedef struct
{
    ...
    uint32_t         RxOwn;                     /* Enables or Disable Receive Own in Half Duplex mode */
...
typedef struct
{
    uint32_t        Attributes;   /* Tx packet HW features capabilities
                                     This parameter must be taken to EthTxPackAttrType */
