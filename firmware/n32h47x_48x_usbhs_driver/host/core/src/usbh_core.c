...
*\*\
**/
void USBH_Init(USB_CORE_MODULE *USBx, USBH_HOST *host, USBH_Class_cb_TypeDef *class_cb, USBH_User_cb_TypeDef *user_cb)
{
    /* Hardware Init */
    USB_BSP_Init();  
...
*\*\
**/
void USBH_Main_Process(USB_CORE_MODULE *USBx , USBH_HOST *host)
{
