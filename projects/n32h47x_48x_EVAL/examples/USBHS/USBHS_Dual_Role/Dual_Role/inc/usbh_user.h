...
#ifndef __USH_USER_H__
#define __USH_USER_H__
...
#define USH_USER_FS_INIT       0u
#define USH_USER_FS_READLIST   1u
#define USH_USER_FS_WRITEFILE  2u
#define USH_USER_FS_DRAW       3u

extern  USBH_User_cb_TypeDef USER_Host_MSC_cb;
