...
/**
*\*\name    Mouse_PositionUpdate.
*\*\fun     The function is to handle mouse scroll to upadte the mouse position through uart port.
...
/**
*\*\name    Mouse_ButtonPress.
*\*\fun     The function is to handle event when the mouse button is pressed
...
/**
*\*\name    Mouse_ButtonRelease.
*\*\fun     The function is to handle event when the mouse button is released
