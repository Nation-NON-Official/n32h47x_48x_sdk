...
#define USBD_PRODUCT_HS_STRING        "MOUSE_HID in HS Mode"
#define USBD_PRODUCT_FS_STRING        "MOUSE_HID in FS Mode"
#define USBD_CONFIGURATION_HS_STRING  "MOUSE HID Config"
#define USBD_INTERFACE_HS_STRING      "MOUSE HID Interface"
#define USBD_CONFIGURATION_FS_STRING  "MOUSE HID Config"
#define USBD_INTERFACE_FS_STRING      "MOUSE HID Interface"
