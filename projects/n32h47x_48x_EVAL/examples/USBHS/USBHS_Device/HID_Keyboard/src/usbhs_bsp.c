...
void KEY_Init(void)
{
    ...
    RCC_EnableAHB1PeriphClk(KEY_BUTTON_S2_GPIO_CLK |KEY_BUTTON_S3_GPIO_CLK | KEY_BUTTON_S4_GPIO_CLK , ENABLE);
    
    GPIO_InitStruct(&GPIO_InitStructure);

    GPIO_InitStructure.Pin            = KEY_BUTTON_S2_PIN ;
    GPIO_InitStructure.GPIO_Mode      = GPIO_MODE_INPUT;
    GPIO_InitStructure.GPIO_Pull      = GPIO_PULL_UP;
    GPIO_InitPeripheral(KEY_BUTTON_S2_GPIO_PORT, &GPIO_InitStructure);
    
    GPIO_InitStructure.Pin            = KEY_BUTTON_S3_PIN ;
    GPIO_InitPeripheral(KEY_BUTTON_S3_GPIO_PORT, &GPIO_InitStructure);
    
    GPIO_InitStructure.Pin            = KEY_BUTTON_S4_PIN ;
    GPIO_InitPeripheral(KEY_BUTTON_S4_GPIO_PORT, &GPIO_InitStructure);
