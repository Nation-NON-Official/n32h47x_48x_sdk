...
#define USBD_PRODUCT_HS_STRING        "KEYBOARD HID in HS Mode"
#define USBD_PRODUCT_FS_STRING        "KEYBOARD HID in FS Mode"
#define USBD_CONFIGURATION_HS_STRING  "KEYBOARD HID Config"
#define USBD_INTERFACE_HS_STRING      "KEYBOARD HID Interface"
#define USBD_CONFIGURATION_FS_STRING  "KEYBOARD HID Config"
#define USBD_INTERFACE_FS_STRING      "KEYBOARD HID Interface"
