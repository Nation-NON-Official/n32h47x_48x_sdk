1、功能说明
    ...
    此例程提供了一种DMA MemtoMem模式用法，使用突发模式在FLASH与RAM之间传输数据。
...
1. Function Description
    ...
    This routine provides a DMA MemtoMem mode usage to transfer data between FLASH and RAM using burst mode.
...
3. Use instructions
    ...
    5. Test steps and phenomena
        ...
        b, DMA transfer completed, LED1 blinking
