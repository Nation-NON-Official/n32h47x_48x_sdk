...
{
    if ((USART_GetFlagStatus(USARTy, USART_FLAG_RXDNE) != RESET) && (USART_GetIntStatus(USARTy, USART_INT_RXDNE) != RESET))
    {
    ...
    if ((USART_GetFlagStatus(USARTy, USART_FLAG_TXDE) != RESET) && (USART_GetIntStatus(USARTy, USART_INT_TXDE) != RESET))
    {
