...
int main(void)
{
    ...
    USART_CfgDriverAssertTime(USARTz,1);
    USART_CfgDriverdeassertTime(USARTz,0);
    USART_DriverPolaritySet(USARTz,DISABLE);
    USART_DriverModeSet(USARTz,ENABLE);
...
{
    /* Enable GPIO clock */
    RCC_EnableAHB1PeriphClk(USARTz_GPIO_CLK,ENABLE);
...
void GPIO_Configuration(void)
{
    ...
    /* Configure USARTz DE as alternate function input and pull-up */
    GPIO_InitStructure.Pin            = USARTz_DEPin;
    GPIO_InitStructure.GPIO_Alternate = USARTz_DE_GPIO_AF;
    GPIO_InitPeripheral(USARTz_GPIO, &GPIO_InitStructure);
}
