...
3、使用说明
    系统配置:
        ...
        2、时钟频率：
        	N32H473/474系列：
			    HSI=8M,SYS_CLK=200M,PCLK1=50M,PCLK2=100M,GTIM2_CLK=100M,GTIM5_CLK=100M,GTIM6_CLK=100M
       	    N32H475/482/487系列：
                HSI=8M,SYS_CLK=240M,PCLK1=60M,PCLK2=120M,GTIM2_CLK=120M,GTIM5_CLK=120M,GTIM6_CLK=120M
        2、端口配置：
                    PA6选择为GTIM2的CH1输出
                    PA2选择为GTIM5的CH1输出
                    PD5选择为GTIM6的CH1输出
