...
#define TIMx_CH3_GPIO_CLK      RCC_AHB_PERIPHEN_GPIOA
#define TIMx_CH3_GPIO_PORT     GPIOA
#define TIMx_CH3_GPIO_PIN      GPIO_PIN_2
#define TIMx_CH3_GPIO_AF       GPIO_AF3

#define TIMx_CH4_GPIO_CLK      RCC_AHB_PERIPHEN_GPIOA
#define TIMx_CH4_GPIO_PORT     GPIOA
