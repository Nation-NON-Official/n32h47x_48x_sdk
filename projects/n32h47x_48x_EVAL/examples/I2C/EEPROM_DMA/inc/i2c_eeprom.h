...
#define I2Cx_scl_clk_en()        RCC_EnableAHB1PeriphClk(RCC_AHB_PERIPHEN_GPIOD, ENABLE)
#define I2Cx_sda_clk_en()        RCC_EnableAHB1PeriphClk(RCC_AHB_PERIPHEN_GPIOD, ENABLE)
...
#define I2Cx_peripheral_clk_en() RCC_EnableAPB1PeriphClk(RCC_APB1_PERIPH_I2C1, ENABLE)
#define I2Cx_scl_clk_en()        RCC_EnableAHB1PeriphClk(RCC_AHB_PERIPHEN_GPIOB, ENABLE)
#define I2Cx_sda_clk_en()        RCC_EnableAHB1PeriphClk(RCC_AHB_PERIPHEN_GPIOB, ENABLE)

#endif

#define I2C_DMA_TX_Remap    DMA_REMAP_I2C1_TX
#define I2C_DMA_RX_Remap    DMA_REMAP_I2C1_RX
#endif
...
#define sEE_FLAG_TIMEOUT ((uint32_t)0x8000)
