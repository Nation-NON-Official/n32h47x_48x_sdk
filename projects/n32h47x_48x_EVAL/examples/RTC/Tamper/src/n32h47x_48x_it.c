...
/*  file (startup_n32h47x_48x.s).                                                 */
/******************************************************************************/

/**
*\*\name    SysTick_Handler.
*\*\fun     This function handles RTC Tamper interrupt.
*\*\param   none
*\*\return  none
*\*\
**/
...
{
    if (RTC_GetITStatus(RTC_INT_TAMP1) != RESET)
    {
       RTC_ClrIntPendingBit(RTC_INT_TAMP1);
       EXTI_ClrITPendBit(EXTI_LINE19);
       log_info("RTC Tamper Interrupt");
    }
}
