...
void SHRTIM1_MspInit(void)
{
    ...
    /* Configure HRTIM input: EXEV3 and EXEV4 external events (PB7 and PB6) */
    GPIO_InitStructure.Pin = GPIO_PIN_6 | GPIO_PIN_7;
    GPIO_InitStructure.GPIO_Mode = GPIO_MODE_INPUT;
    GPIO_InitPeripheral(GPIOB, &GPIO_InitStructure);
    AFIO_Config_SHRTIM_EXEV_Pin(AFIO_SHRTIM_EXEV_3, GPIOB_PORT_SOURCE, GPIO_PIN_SOURCE7);
    AFIO_Config_SHRTIM_EXEV_Pin(AFIO_SHRTIM_EXEV_4, GPIOB_PORT_SOURCE, GPIO_PIN_SOURCE6);
