...
#define BUTTION_PIN GPIO_PIN_5
#define BUTTION_PORT GPIOC
#define BUTTON_PRESSED() (BUTTION_PORT->PID & (uint32_t)BUTTION_PIN)
#define BUTTON_CLOCK_ENABLE()  RCC_EnableAHB1PeriphClk(RCC_AHB_PERIPHEN_GPIOC, ENABLE);
