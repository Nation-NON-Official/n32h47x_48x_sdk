...
#define SCREEN_X_SIZE    ((uint16_t)158)
#define SCREEN_Y_SIZE    ((uint8_t)130)
...
void InitTIMER(void)
{
    ...
    TIM_TimeBaseStructure.Prescaler = ((RCC_Clocks.HclkFreq / 50000));
