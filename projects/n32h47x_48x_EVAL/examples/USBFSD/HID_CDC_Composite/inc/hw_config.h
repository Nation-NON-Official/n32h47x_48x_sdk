...
#define CDC_USARTx              USART1
#define CDC_PERIPH              RCC_APB2_PERIPH_USART1
#define CDC_GPIO                GPIOA
#define CDC_PERIPH_GPIO         RCC_AHB_PERIPHEN_GPIOA 
#define CDC_USART_IRQn          USART1_IRQn
#define CDC_USART_IRQHandler    USART1_IRQHandler
#define CDC_TX_PIN              GPIO_PIN_9
#define CDC_RX_PIN              GPIO_PIN_10
#define CDC_TX_AF               ((uint32_t)5)
#define CDC_RX_AF               ((uint32_t)5)
