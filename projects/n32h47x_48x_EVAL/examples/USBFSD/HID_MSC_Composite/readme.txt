...
3. 使用说明
    ...
    描述Demo的测试步骤和现象 
         1. 编译后下载程序复位运行；
         2. 通过 USB 线连接 J4 USB 口，电脑识别出 U 盘设备和HID设备;
...
3. Instructions for use
    ...
    Describe the testing steps and phenomena of the Demo
        ...
        2. Connect the J4 USB port via a USB cable, and the computer recognizes the HID device and USB flash.
