...
extern void netbiosns_init(void);
...
int main(void)
{
    ...
    log_info("ETH no RTOS NetBIOS Name Service (NBNS) demo go...\r\n");
    ...
    netbiosns_init();
    /* Note that the hostname must be less than 15 characters */
    netbiosns_set_name(NETBIOS_HOST_NAME);
    
    log_info("Local NetBIOS name: %s\n", NETBIOS_HOST_NAME);
    log_info("You can test the ping command with this name\n");
