...
void OV5640_InitPort(void)
{
    ...
    AFIO_ConfigPinTol5V(DVP_MODULE_REMAP0_HSYNC_PORT, DVP_MODULE_REMAP0_HSYNC_PIN,DISABLE);
    ...
    AFIO_ConfigPinTol5V(DVP_MODULE_REMAP0_VSYNC_PORT, DVP_MODULE_REMAP0_VSYNC_PIN,DISABLE);
    ...
    AFIO_ConfigPinTol5V(DVP_MODULE_REMAP0_PCLK_PORT, DVP_MODULE_REMAP0_PCLK_PIN,DISABLE);                                                                          
    ...
    AFIO_ConfigPinTol5V(DVP_MODULE_REMAP0_DATA0_PORT, DVP_MODULE_REMAP0_DATA0_PIN,DISABLE);
    ...
    AFIO_ConfigPinTol5V(DVP_MODULE_REMAP0_DATA1_PORT, DVP_MODULE_REMAP0_DATA1_PIN,DISABLE);
    ...
    AFIO_ConfigPinTol5V(DVP_MODULE_REMAP0_DATA2_PORT, DVP_MODULE_REMAP0_DATA2_PIN,DISABLE);
    ...
    AFIO_ConfigPinTol5V(DVP_MODULE_REMAP0_DATA3_PORT, DVP_MODULE_REMAP0_DATA3_PIN,DISABLE);
    ...
    AFIO_ConfigPinTol5V(DVP_MODULE_REMAP0_DATA4_PORT, DVP_MODULE_REMAP0_DATA4_PIN,DISABLE);
    ...
    AFIO_ConfigPinTol5V(DVP_MODULE_REMAP0_DATA5_PORT, DVP_MODULE_REMAP0_DATA5_PIN,DISABLE);
    ...
    AFIO_ConfigPinTol5V(DVP_MODULE_REMAP0_DATA6_PORT, DVP_MODULE_REMAP0_DATA6_PIN,DISABLE);
    ...
    AFIO_ConfigPinTol5V(DVP_MODULE_REMAP0_DATA7_PORT, DVP_MODULE_REMAP0_DATA7_PIN,DISABLE);
